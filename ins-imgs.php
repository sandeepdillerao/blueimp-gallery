...
$imageFolder = 'https://onlinesggs.org/placement/Research/Gallery/images/';
...
foreach ($sortedImages as $image) {
    ...
    $lastModified = '(Uploaded On: ' . date('d F, Y H:i:s', filemtime($image)) . ')';

    # Begin adding
    writeHtml('<a name="' . $image . '" href="' . $image . '"  data-gallery>');
    writeHtml('<img src="' . $image . '" style="width:160px;height:160px;padding:2px;" alt="' . $name . '" title="' . $lastModified . '" >');
    writeHtml('</a>');
}
